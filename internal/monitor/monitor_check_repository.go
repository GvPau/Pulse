...
func (r *Repository) SaveMonitorCheck(ctx context.Context, c *Check) error {
	_, err := r.pool.Exec(ctx,
		`INSERT INTO monitor_checks (id, monitor_id, status_code, response_time_ms, success, error, checked_at)
	VALUES ($1, $2, $3, $4, $5, $6, $7)`,
		c.ID, c.MonitorID, c.StatusCode, c.ResponseTimeMS, c.Success, c.Error, c.CheckedAt)
